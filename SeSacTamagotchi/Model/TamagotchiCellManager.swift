...
struct TamagotchiCollectionViewManager {
    ...
    let defaultCell = TamagotchiCellInfo(name: "준비중이에요", imageString: "noImage", description: "준비중이에요")
    ...
    init() {
        tamagotchiList = [
            TamagotchiCellInfo(name: "따끔따끔 다마고치", imageString: "1-6", description: "따끔따끔 다마고치입니당~ 키는 200km 몸무게는 200톤이에용~\n성격은 이름처럼 따끔합니당~\n잘먹으니까 밥은 자주 주셔야되구요\n물도 잘 주셔야되는디~\n감당할 수 있쥬?"),
